        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeal = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryPhone = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    SubstitutionPreference = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    OrderReviewId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Rating = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductReviews_OrderReviews_OrderReviewId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_OrderReviewId_ProductId",
                table: "ProductReviews",
                columns: new[] { "OrderReviewId", "ProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealtimeEvents_OrderId",
                table: "RealtimeEvents",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_RealtimeEvents_UserId",
                table: "RealtimeEvents",
                column: "UserId");
